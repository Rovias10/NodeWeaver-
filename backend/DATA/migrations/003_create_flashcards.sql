...
-- soporta esa feature: cada flashcard puede o no estar vinculada a un
...
-- backend recalcula los 3 campos y `next_review_at`.
-- =====================================================================
...
CREATE TABLE IF NOT EXISTS flashcards (
    ...
    -- Estado del algoritmo SM-2 simplificado
    ...
    CONSTRAINT fk_flashcards_map
        FOREIGN KEY (map_id) REFERENCES maps(id)
        ON DELETE SET NULL ON UPDATE CASCADE,
        -- SET NULL: si se borra el mapa origen, la flashcard sobrevive
        -- como tarjeta suelta (el usuario no debería perder progreso de
        -- estudio sólo porque borró el mapa de origen).

    INDEX idx_user_due (user_id, next_review_at)
        -- listado "tarjetas a repasar hoy" del dashboard.
) ENGINE=InnoDB
